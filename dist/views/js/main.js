...
var resizePizzas = function(size) {
  ...
  //replaced querySelectory  with getElementById
...
/*
  ...
  */
//moved dx and newwidth out of for loop per code review and added allPizzaContainers to streamline
  function changePizzaSizes(size) {
...
// Moved var pizzaDiv out of the for loop to increase speed
...
function updatePositions() {
  ...
  //removed 'scrollTop' call from loop to eliminate forced synchronous layout
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  //delcare variable elem to avoid redundant creation in
  var elem;
  for (var i = 0; i < 200; i++) {
